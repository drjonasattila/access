...
- Immersive Damp-Cold, Damp-Heat, Dry-Cold, Dry-Heat, and Tension Release modules in `app/components/AvicennaApp.js`; they embed externally hosted YouTube terrain films at `https://youtu.be/ImpMLWzXdIM`, `https://youtu.be/uzDIVfpVBNI`, `https://youtu.be/PekqIFDvagU`, `https://youtu.be/mO-b_CEx5X8`, and `https://youtu.be/3jI6X8e2J18` and do not store video media in Git.
